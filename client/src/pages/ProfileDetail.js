...
export default function ProfileDetail(props) {
  ...
  let { id } = useParams()
    ...
    function loadUser() {
        ...
        API.getUserListing({ params: { uid: id } })
            .then(res => {
    ...
    return (
        <>
            ...
            <Card className='profileDetails' >
                <Card.Body>
                        <Card.Img className='userImage' variant="top" src="https://cdn4.iconfinder.com/data/icons/small-n-flat/24/user-alt-512.png" alt={"user profile image for " + user.displayName} />
