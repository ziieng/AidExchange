      ...
      <Container className="mb-5 mt-5 py-3 px-4 bg-light rounded w-50">
        ...
        <Form className="" onSubmit={handleFormSubmit}>
          ...
          <Form.Control
            ...
            name="description"
            placeholder="Is there anything folks need to know?"
          />
          <br />
          {contents.map((row, i) => {
            const itemId = "item-" + i;
          ...
          {contentError && (
            <Alert variant="warning">
              Items that don't have BOTH a label and a quantity won't be saved.
            </Alert>
          )}
          <Button
            id="newItem"
          ...
          {/* <Form.Label className="font-weight-bold" >Location:</Form.Label>
                    ...
                    <br /> */}
          <Button id="submit" type="submit" to="/" disabled={loading}>
            Submit
          </Button>
        </Form>
      </Container>
